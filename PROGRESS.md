...
Checkpoint table for the Unified AI Alignment Field Index build. Updated and committed at the end of every subtopic. Resume reads this file first; continue from the first `not started` / `in progress` row.

| Domain | Subtopic | Status | Entries found | Last worked |
|---|---|---|---|---|
| entry-tier | thought experiments (paperclip, orthogonality, instrumental convergence) | not started | | |
