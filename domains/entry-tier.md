...
| Resource | Type | Tier | Prerequisites | Why it matters |
|---|---|---|---|---|
| [Ethical Issues in Advanced Artificial Intelligence](https://nickbostrom.com/ethics/ai) (Nick Bostrom, 2003) | paper | core | — | Origin of the paperclip-maximizer thought experiment, the field's canonical intuition pump for misaligned optimization. |
...
| Resource | Type | Tier | Prerequisites | Why it matters |
|---|---|---|---|---|
| [Extraterrestrial Artificial Intelligence: The Final Existential Risk?](https://www.iza.org/publications/dp/15924/extraterrestrial-artificial-intelligence-the-final-existential-risk) (Wim Naudé, 2023) | paper | deep | The Great Filter: Are We Almost Past It?, Where Are They?: Why I Hope the Search for Extraterrestrial Life Finds Nothing | One of the few rigorous attempts to put the AI-Fermi connection on a scholarly economic footing. |
| [Rare AI and the Fermi Paradox](https://www.lesswrong.com/posts/jJPTRextDe3chGjho/rare-ai-and-the-fermi-paradox) (dawnstrata, 2025) | essay | deep | The Great Filter: Are We Almost Past It? | A current, argued challenge to optimistic resolutions of the Fermi paradox that exempt AI from evolutionary dynamics. |
| [No Strong Orthogonality From Selection Pressure](https://www.lesswrong.com/posts/wtCtkyBiNosDPgiHc/no-strong-orthogonality-from-selection-pressure) (lumpenspace, 2026) | essay | deep | Orthogonality Thesis, The Superintelligent Will: Motivation and Instrumental Rationality in Advanced Artificial Agents | A recent, argued challenge to a load-bearing premise of the standard x-risk picture. |
