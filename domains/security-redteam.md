...
**21 live/paywalled entries** · catalog domain id: `security-redteam`
...
| [Prompt Injection (blog series)](https://simonwillison.net/series/prompt-injection/) (Simon Willison, 2023) | community | entry | — | The clearest accessible map of the prompt-injection problem and its evolving defense landscape — where most practitioners first learn why 'ignore previous instructions' is unsolvable in general. |
...
| Resource | Type | Tier | Prerequisites | Why it matters |
|---|---|---|---|---|
| [BadNets: Identifying Vulnerabilities in the Machine Learning Model Supply Chain](https://arxiv.org/abs/1708.06733) (Tianyu Gu, Brendan Dolan-Gavitt, Siddharth Garg, 2017) | paper | core | — | Founded the entire backdoor research field: the lesson that a model's provenance is a security property, and that 'it works on the test set' does not mean it is trustworthy. |
...
| [Ignore Previous Prompt: Attack Techniques for Language Models](https://arxiv.org/abs/2211.09527) (Fábio Perez, Ian Ribeiro, 2022) | paper | core | — | The foundational taxonomy of direct prompt injection — the vocabulary (goal hijacking, prompt leaking) that the entire field now uses. |
...
| [Not What You've Signed Up For: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection](https://arxiv.org/abs/2302.12173) (Kai Greshake, Sahar Abdelnabi, Shailesh Mishra et al., 2023) | paper | core | — | Established that the boundary between instructions and data is the core security vulnerability of LLM applications — with agentic systems, the stakes escalate to unauthorized actions, not just weird outputs. |
...
| [Poisoning Language Models During Instruction Tuning](https://arxiv.org/abs/2305.00944) (Alexander Wan, Eric Wallace, Sheng Shen et al., 2023) | paper | core | Sleeper Agents: Training Deceptive LLMs that Persist Through Safety Training | The cleanest demonstration that the modern LLM training pipeline is an open supply chain: anyone contributing data can plant behaviors that survive into deployment undetected. |
...
| Resource | Type | Tier | Prerequisites | Why it matters |
|---|---|---|---|---|
| [Manipulating Machine Learning: Poisoning Attacks and Countermeasures for Regression Learning](https://arxiv.org/abs/1804.00308) (Matthew Jagielski, Alina Oprea, Battista Biggio et al., 2018) | paper | deep | BadNets: Identifying Vulnerabilities in the Machine Learning Model Supply Chain | Established the theory that poisoning is not just an empirical trick but a well-defined optimization problem — the foundation on which modern LLM data-poisoning analyses build. |
...
| [Prompt Injection Attack Against LLM-Integrated Applications](https://arxiv.org/abs/2306.05499) (Yi Liu, Gelei Deng, Yuekang Li et al., 2023) | paper | deep | Ignore Previous Prompt: Attack Techniques for Language Models | The strongest empirical evidence that prompt injection is not theoretical — a large fraction of deployed LLM applications were concretely exploitable in 2023. |
...
| [A Survey of Recent Backdoor Attacks and Defenses in Large Language Models](https://arxiv.org/abs/2406.06852) (Shuai Zhao, Meihuizi Jia, Zhongliang Guo et al., 2024) | paper | deep | BadNets: Identifying Vulnerabilities in the Machine Learning Model Supply Chain | The current best map of the LLM backdoor landscape; essential orientation for anyone assessing supply-chain risk in modern training pipelines. |
