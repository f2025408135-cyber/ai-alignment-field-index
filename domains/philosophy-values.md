...
**19 live/paywalled entries** · catalog domain id: `philosophy-values`
...
| [The Repugnant Conclusion (Stanford Encyclopedia of Philosophy)](https://plato.stanford.edu/entries/repugnant-conclusion/) (Gustaf Arrhenius, 2006) | essay | core | — | Population ethics is the deep background for longtermist and astronomical-waste arguments that dominate macrostrategy — and any AI optimized for total welfare must take a stance on the Repugnant Conclusion. |
...
| [Population Axiology](https://users.ox.ac.uk/~mert2255/papers/population_axiology.pdf) (Hilary Greaves, 2017) | paper | core | The Repugnant Conclusion (Stanford Encyclopedia of Philosophy) | The leading accessible map of population ethics, and the frame for Greaves & MacAskill's 'strong longtermism' — the moral theory that underwrites the case for prioritizing AI risk above almost everything else. |
...
| [Beyond Astronomical Waste](https://www.lesswrong.com/posts/Qz6w4GYZpgeDp6ATB/beyond-astronomical-waste) (Wei Dai, 2018) | community | deep | Astronomical Waste: The Opportunity Cost of Delayed Technological Development | Directly connects population ethics to alignment: it reframes getting alignment right as a question of which moral population counts, making population axiology a first-order alignment concern. |
...
| [What if Ethics is Provably Self-Contradictory?](https://www.lesswrong.com/posts/kx2BTnWiZxkwqkSkj/what-if-ethics-is-provably-self-contradictory) (Yitz, 2024) | community | deep | The Repugnant Conclusion (Stanford Encyclopedia of Philosophy) | The sharpest community statement that population ethics is not a footnote but a constraint on alignment itself: value targets may be internally inconsistent exactly where advanced AI takes us. |
